...
def initialisation():
    """
    displays messages on the command lines that indicate if the user are in the good path.
    Also provide a list interface of different filters available.
    And a list of ofs commands
...
def get_filter(argument):
    """
    extract the filter, and make it applicable by the user
